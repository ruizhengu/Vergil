        ...
        if approval_response.approved:
            ...
            try:
                ...
                error_payload = {
                    ...
                    "validation_error": smt_error.payload.model_dump(),
                }
                logger.error("Approval SMT validation failed", extra=error_payload)
                ...
                error_payload = {
                    "approval_id": approval_response.approval_id,
                    "validation_error": validation_error.payload.model_dump(),
                }
